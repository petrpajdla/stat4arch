...
- [{{< bi file-earmark-arrow-down >}} `graves.csv`](data/graves.csv) -- grave information and grave features, human remains information;
- [{{< bi file-earmark-arrow-down >}} `artefacts.csv`](data/artefacts.csv) -- artefact records with materials, weights, preservation etc.
